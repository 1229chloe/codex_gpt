...
if st.session_state.step == 7:
    ...
    2. 개정된 제품정보""", unsafe_allow_html=True)
    ...
    10. 변경 전·후 출발 물질 또는 중간체의 최소 1배치에 대한 시험 성적서(해당하는 경우), 출발물질 또는 중간체 변경 전·후 최종 원료의약품 2배치에 대한 배치분석 자료.""", unsafe_allow_html=True)
